  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved ask as @ask" do
        ...
        post :create, {:ask => { "title" => "invalid value" }}, valid_session
        assigns(:ask).should be_a_new(Ask)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ask" do
        ...
        Ask.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => ask.to_param, :ask => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ask as @ask" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ask.any_instance.stub(:save).and_return(false)
        put :update, {:id => ask.to_param, :ask => { "title" => "invalid value" }}, valid_session
        assigns(:ask).should eq(ask)
      end
